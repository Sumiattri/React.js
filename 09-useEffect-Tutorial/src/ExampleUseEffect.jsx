...
// useEffect in present provide functionality of componentDidMount
...
// if dependency array has some value, then useEffect will be called only when that value chmages
